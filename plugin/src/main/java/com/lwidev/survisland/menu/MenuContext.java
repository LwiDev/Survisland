...
public record MenuContext(Survisland plugin, TeamManager teamManager, AnnouncementService announcementService, TimerService timerService, VoteService voteService) {
}
