...
| `/say` | — | `<message>` | Diffuse un message formaté à tous les joueurs (+ son configurable) | `survisland.say` | op |
| `/config` | — | `reload` | Recharge `config.yml` | `survisland.config.reload` | op |
